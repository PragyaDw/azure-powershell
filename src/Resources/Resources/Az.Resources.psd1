...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added ''New-AzDenyAssignment'' cmdlet for creating user-assigned deny assignments using the ''2024-07-01-preview'' API. Deny assignments allow denying specific write, delete, and action operations to all principals at a given scope while excluding specified principals.
